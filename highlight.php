...
class HighlightPlugin extends Plugin
{
	...
	$this->grav['assets']->addCss('plugin://highlight/js/styles/'.$theme.'.min.css');
        $this->grav['assets']->addCss('plugin://highlight/js/styles/base16/'.$theme.'.min.css');
        ...
        if ($this->config->get('plugins.highlight.lines')) {
            ...
            $this->grav['assets']->addCss('plugin://highlight/js/styles/highlightjs-line-numbers.css');
        }
